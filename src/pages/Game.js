    ...
    return (
      <div className='h-screen w-screen'>
        ...
        <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2'>
          <div className='flex items-center justify-center text-center mt-5 prose dark:prose-invert'>
            <div className='flex-col items-center justify-center w-full'>
              <div className='mb-2'>
                <Header />
              </div>
              <div className='bg-black bg-opacity-50 w-full px-5 py-2 text-xl rounded-2xl text-white'>
                <CardGame
                  { ...this.props }
                />
              </div>
